...
const textViewContainer = document.body.appendChild(document.createElement("div"));
...
const TextViewFactory = React.createFactory(TextView);

React.render(TextViewFactory(), textViewContainer);
